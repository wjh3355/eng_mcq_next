...
import { EMPTY_DEFINITION_QN_OBJ, DefinitionQnObj, DefinitionProps } from "@/definitions";
...
export default function useDefinition({ qnNumArray, email }: { qnNumArray: number[], email: string }): DefinitionProps {
